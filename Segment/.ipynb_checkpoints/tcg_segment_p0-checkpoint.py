...
datain_path='/N/project/hurricane-deep-learning/data/ncep_extracted_41x161/'
dataout_path='/N/slate/ckieu/tmp/output/ncep_extracted_41x161_12h/'
df_train = pd.read_csv(datain_path+'tc_12h_train.csv')
df_val = pd.read_csv(datain_path+'tc_12h_val.csv')
df_test = pd.read_csv(datain_path+'tc_12h_test.csv')
df_all = pd.read_csv(datain_path+'tc_12h.csv')
#
